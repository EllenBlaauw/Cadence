...
def register_user(username, email, password, birthdate):
    conn = sqlite3.connect('journal.db')
    c = conn.cursor()
    try:
        hashed_pw = hash_password(password)
        c.execute('''INSERT INTO users (username, email, password_hash, birthdate)
                     VALUES (?, ?, ?, ?)''',
                  (username, email, hashed_pw, birthdate))
        conn.commit()
        return True
...
def show_login_form():
    ...
    st.markdown("""
    <style>
    .st-emotion-cache-1v0mbdj {  /* Target the image container */
        border-radius: 15px;
        overflow: hidden;
    ...
    with col2:
        st.markdown("""
            <svg xmlns="http://www.w3.org/2000/svg" width="400" height="400" viewBox="0 0 887.77227 772.83071" xmlns:xlink="http://www.w3.org/1999/xlink" role="img" artist="Katerina Limpitsouni" source="https://undraw.co/">
  ...
  <circle cx="731.82227" cy="101.66024" r="101.66024" fill="#45b7af"/>
  <path d="M335.9542,797.01953s1.487-31.15875,31.97119-27.537" transform="translate(-156.11386 -63.58465)" fill="#3f3d56"/>
  <circle cx="171.2269" cy="688.52637" r="15.25711" fill="#b2a9f5"/>
  ...
  <circle cx="673.67331" cy="693.8489" r="15.25711" fill="#b2a9f5"/>
  ...
  <circle cx="747.12416" cy="699.17142" r="15.25711" fill="#b2a9f5"/>
  ...
  <circle cx="291.51598" cy="673.6233" r="15.25711" fill="#b2a9f5"/>
  ...
  <circle cx="64.77639" cy="678.94583" r="15.25711" fill="#b2a9f5"/>
  ...
  <path d="M393.47351,507.83307h0a48.89061,48.89061,0,0,1,48.89061,48.89061v24.44543a48.89061,48.89061,0,0,1-48.89061,48.89061h0a0,0,0,0,1,0,0V507.83307A0,0,0,0,1,393.47351,507.83307Z" transform="translate(679.72382 1074.30814) rotate(180)" fill="#b2a9f5"/>
  <path d="M598.30346,444.24843h0A48.89061,48.89061,0,0,1,647.19412,493.139v24.44543a48.89061,48.89061,0,0,1-48.89061,48.89061h0a0,0,0,0,1,0,0V444.24843A0,0,0,0,1,598.30346,444.24843Z" fill="#b2a9f5"/>
  <path d="M780.03662,560.56514H772.2795c0-98.37742-80.03569-178.41374-178.41374-178.41374-98.37742,0-178.41374,80.03632-178.41374,178.41374H407.6949c0-102.655,83.51592-186.17086,186.17086-186.17086C696.52134,374.39428,780.03662,457.91019,780.03662,560.56514Z" transform="translate(-156.11386 -63.58465)" fill="#b2a9f5"/>
  ...
  <path d="M283.90741,319.4701c-18.08491-10.33993-14.46594-33.03029-14.46594-33.03029-.455-14.7407-12.63376-12.65406-12.63376-12.65406l-4.43241,1.01143a13.4583,13.4583,0,0,0-6.59088-1.219l-6.7425,1.13469c15.353,3.60738,14.09161,16.45074,14.09161,16.45074l2.15092,15.0171-40.229-16.2288,4.61893-10.89082a19.45075,19.45075,0,0,0,1.627-3.17306c3.26633-8.24724-2.90271-16.45062-8.73461-18.76034s-13.20748,2.50356-16.47381,10.75068c-3.22184,8.13468-.07322,18.46919,5.60983,20.96607l-.00479.00983,12.10177,5.03977.09011-.28534Zm-20.429-26.3861,1.29451,14.42385c-7.59564-10.08294-6.04314-22.06233-6.04314-22.06233a13.925,13.925,0,0,0-2.69425-7.71121C264.76078,282.95569,263.47837,293.084,263.47837,293.084Z" transform="translate(-156.11386 -63.58465)" fill="#3f3d56"/>
        ...
        #         caption="Your journey to digital wellness starts here")
...
def show_registration_form():
    with st.form("Register"):
        ...
        birthdate = st.date_input("Birthdate", min_value=datetime(1900,1,1),
                                max_value=datetime.today(),
                                help="You must be at least 13 years old to register")
        ...
        if st.form_submit_button("Register"):
            ...
            if register_user(username, email, password, birthdate):
